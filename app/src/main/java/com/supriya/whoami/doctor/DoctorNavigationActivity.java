...
public class DoctorNavigationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container_doctor,new DoctorDashboardFragment());
        ...
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container_doctor,new DoctorDashboardFragment()).commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.logoutD:
                auth.signOut();
                startActivity(new Intent(DoctorNavigationActivity.this, LoginActivity.class));
                finish();
                break;
        }
