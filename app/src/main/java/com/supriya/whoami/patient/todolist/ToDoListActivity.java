...
public class ToDoListActivity extends ToDoListBaseActivity implements CreateTaskBottomSheetFragment.setRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTask.setOnClickListener(view -> {
            ...
            createTaskBottomSheetFragment.setTaskId(0, false, this, ToDoListActivity.this);
