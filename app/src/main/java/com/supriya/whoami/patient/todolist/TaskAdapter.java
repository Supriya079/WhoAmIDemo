...
import com.supriya.whoami.room.DatabaseClient;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(ToDoListActivity context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public void showPopUpMenu(View view, int position) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.todolistmenu, popupMenu.getMenu());
