...
import com.supriya.whoami.setReminder.AlarmBrodcast;
...
public class CreateEventG extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_event_g);
        ...
        databaseClass = WhoAmIDB.getInstance(getApplicationContext());
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intent = new Intent(getApplicationContext(), AlarmBrodcastG.class);
